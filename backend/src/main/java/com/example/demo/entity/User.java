...
public class User {
	...
	public List<Learning> getLearningCourses() { return learningCourses; }
	public void setLearningCourses(List<Learning> learningCourses) { this.learningCourses = learningCourses; }
